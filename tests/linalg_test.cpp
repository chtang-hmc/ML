...
TEST(VectorTest, ComparisonOperators) {
    ...
    linalg::Vector<double> v4(std::vector<double>({1.0, 2.0}));
...
TEST(VectorTest, Norm) {
    linalg::Vector<double> v1(std::vector<double>({3.0, 4.0}));
...
TEST(VectorTest, Normalize) {
    ...
    linalg::Vector<double> v3(std::vector<double>({3.0, 4.0}));
    v3.normalize(1);
...
TEST(MatrixTest, ArithmeticOperators) {
    ...
    linalg::Vector<double> v(std::vector<double>({5.0, 6.0}));
...
TEST(MatrixTest, MatrixVectorMultiplication) {
    ...
    linalg::Vector<double> v2(std::vector<double>({1.0, 2.0}));
    ...
    linalg::Vector<double> v3(std::vector<double>({1.0, 2.0}));
